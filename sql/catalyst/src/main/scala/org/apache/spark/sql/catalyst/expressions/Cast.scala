...
case class Cast(child: Expression, dataType: DataType) extends UnaryExpression {
  ...
  private[this] def castToByteArray: Any => Any = child.dataType match {
    case BinaryType => buildCast[Array[Byte]](_, new String(_, "UTF-8"))
    case TimestampType => buildCast[Timestamp](_, timestampToString)
    case _ => buildCast[Any](_, _.toString)
  }
  ...
  private[this] def castToBoolean: Any => Any = child.dataType match {
    ...
    case ByteArrayType =>
      buildCast[String](_, s => try s.toBoolean catch {
  ...
  private[this] def castToTimestamp: Any => Any = child.dataType match {
    case StringType =>
      buildCast[String](_, stringToTimestamp)
    case ByteArrayType =>
      buildCast[String](_, stringToTimestamp)
    case BooleanType =>
  ...
  private[this] def castToLong: Any => Any = child.dataType match {
    ...
    case ByteArrayType =>
      buildCast[String](_, s => byteArrayToIntegral(s, (_: String).toLong, (_: Double).toLong))
    case BooleanType =>
  ...
  private[this] def castToInt: Any => Any = child.dataType match {
    ...
    case ByteArrayType =>
      buildCast[String](_, s => byteArrayToIntegral(s, (_: String).toInt, (_: Double).toInt))
    case BooleanType =>
  ...
  private[this] def castToShort: Any => Any = child.dataType match {
    ...
    case ByteArrayType =>
      buildCast[String](_, s => byteArrayToIntegral(s, (_: String).toShort, (_: Double).toShort))
    case BooleanType =>
